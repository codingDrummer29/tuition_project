            ...
            for (int i = 0; itemline[i] != null; i++) {
                if (idx == i) {
                    ...
                    if ((qty <= qty_prv) && (qty_prv != 0)) {
                        ...
                        jTable2.setValueAt(Integer.parseInt(jTextField1.getText()), r, 0);
                        jTable2.setValueAt(temp[0], r, 1);
                        jTable2.setValueAt(qty, r, 2);
  ...
  throws PrinterException
  {
      ...
      int result = NO_SUCH_PAGE;
        ...
        try{
            ...
            ///////////////// Product names and prices Get ///////////
            String  pn1a,pn2a,pn3a,pn4a;
            double  pp1a,pp2a,pp3a,pp4a;
            
            try
            {
                pn1a=jTable2.getValueAt(0, 1).toString(); //pn1.getText();
                pp1a=Double.parseDouble(""+jTable2.getValueAt(0, 3));//Integer.valueOf(pp1.getText());
            }catch(Exception e)
            {
               pn1a=""; 
               pp1a=0.0;
            ...
            try
            {
                pn2a=jTable2.getValueAt(1, 1).toString();//pn2.getText();
                pp2a=Double.parseDouble(""+jTable2.getValueAt(1, 3));//Integer.valueOf(pp2.getText());
            }catch(Exception e)
            {
               pn2a=""; 
               pp2a=0.0;
            ...
            try
            {
                pn3a=jTable2.getValueAt(2, 1).toString();//pn3.getText();
                pp3a=Double.parseDouble(""+jTable2.getValueAt(2, 3));//Integer.valueOf(pp3.getText());
            }catch(Exception e)
            {
               pn3a=""; 
               pp3a=0.0;
            ...
            try
            {
                pn4a=jTable2.getValueAt(3, 1).toString();//pn4.getText();
                pp4a=Double.parseDouble(""+jTable2.getValueAt(3, 3));//Integer.valueOf(pp4.getText());
            }catch(Exception e)
            {
               pn4a=""; 
               pp4a=0.0;
            ...
            g2d.drawString("      Departmental Store Bill Receipt        ",12,y);y+=yShift;
            ...
            g2d.drawString("             9051428309             ",10,y);y+=yShift;
            g2d.drawString("*************************************",10,y);y+=yShift;
...
//            g2d.drawString("Customer Shopping Invoice", 30,y);y+=yShift;
 ...
 PrinterJob pj = PrinterJob.getPrinterJob();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        jTabbedPane1.setEnabledAt(0,Login.status);
        jTabbedPane1.setEnabledAt(2,Login.status);
